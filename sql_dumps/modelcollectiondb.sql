...
CREATE TABLE IF NOT EXISTS `modelcollectiondb`.`gundam` (
  ...
  `series` VARCHAR(255) NULL COMMENT 'The gundam series where the model came from (e.g. Gundam 00, BB Senshi)',
  `series_number` INT NULL,
  `model_number` VARCHAR(255) NULL COMMENT 'Model number of the gundam (e.g. GAT-X105)',
  `subtitle` TEXT NULL,
...
-- -----------------------------------------------------
-- Table `modelcollectiondb`.`login_token`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `modelcollectiondb`.`login_token` ;

CREATE TABLE IF NOT EXISTS `modelcollectiondb`.`login_token` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `code` VARCHAR(65) NULL,
  `user_id` INT NOT NULL,
  PRIMARY KEY (`id`, `user_id`),
  INDEX `fk_login_token_user1_idx` (`user_id` ASC),
  CONSTRAINT `fk_login_token_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `modelcollectiondb`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `modelcollectiondb`.`admin`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `modelcollectiondb`.`admin` ;

CREATE TABLE IF NOT EXISTS `modelcollectiondb`.`admin` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `modelcollectiondb`.`admin_token`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `modelcollectiondb`.`admin_token` ;

CREATE TABLE IF NOT EXISTS `modelcollectiondb`.`admin_token` (
  `id` INT NOT NULL,
  `code` VARCHAR(65) NULL,
  `admin_id` INT NOT NULL,
  PRIMARY KEY (`id`, `admin_id`),
  INDEX `fk_admin_token_admin1_idx` (`admin_id` ASC),
  CONSTRAINT `fk_admin_token_admin1`
    FOREIGN KEY (`admin_id`)
    REFERENCES `modelcollectiondb`.`admin` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `modelcollectiondb`.`custom_model` (
  ...
  `name` VARCHAR(255) NULL,
  `description` VARCHAR(255) NULL,
  `type` ENUM('kitbash','combination') NULL COMMENT 'kitbash - made from parts of scrap models' /* comment truncated */ /*combination - made by combining two or more built models*/,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
